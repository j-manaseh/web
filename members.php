...
<div class="sidebar close">
  ...
  <div class="home-section">
    ...
    <div class="container">
            <div class="title">All Our Members</div>
            <div class="content">
            <div class="attendance-list">
            <div class="heading">
                <button class="btn"><a href="register-add.php" >Add New Member</a></button>
            </div>
          <table class="table">
            <thead>
                <tr>
                ...
                if(mysqli_num_rows($query_run) > 0)
                {
                    foreach($query_run as $row)
                    {
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="register-edit.php?id=<?= $row['id']; ?>" method="POST">
                                    <button type="submit" name="user_edit" value="<?= $row['id']; ?>">Edit</button>
                                </form>
                            </td>
                            <td>
                                <form action="code.php" method="POST">
                                    <button type="submit" name="user_delete" class="table-delete" value="<?= $row['id']; ?>">Delete</button>
                                </form>
                            </td>
                        </tr>
                        <?php
