...
<div class="sidebar close">
  ...
  <div class="home-section">
    ...
    <div class="container">
            ...
            <div class="heading">
              <button class="btn"><a href="add-schedule.php" >Add New Class Schedule</a></button>
                ...
                if(mysqli_num_rows($query_run) > 0)
                {
                    foreach($query_run as $row)
                    {
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="edit-schedule.php?id=<?= $row['class_id']; ?>" method="POST">
                                    <button type="submit" name="class_edit" value="<?= $row['class_id']; ?>">Edit</button>
                                </form>
                            </td>
                            <td>
                                <form action="code.php" method="POST">
                                    <button type="submit" name="schedule_delete" class="table-delete" value="<?= $row['id']; ?>">Delete</button>
                                </form>
                            </td>
                        </tr>
                        <?php
