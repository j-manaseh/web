    ...
    $room = $_POST['room_number'];
      ...
      if (!empty($class_name) || !empty($trainer) || !empty($start) || !empty($end) || !empty($day) || !empty($room)) {
         ...
         if (mysqli_connect_error()) {
           ...
           {
             $SELECT = "SELECT class_name From classes_schedule Where class_name = ? Limit = ?";
             $INSERT = "INSERT Into classes_schedule (class_name, instructor_name, start_time, end_time, day_of_week, room_number) values(?, ?, ?, ?, ?, ?)";
             ...
             if ($rnum==0) {
                 ...
                 $stmt->bind_param("sssssi", $class_name, $trainer, $start, $end, $day, $room);
                 $stmt->execute();
                 ?>
                 <script type="text/javascript">
                 window.location.href = 'classes_schedule.php';
                 </script>
                 <?php
             }
             else
...
<div class="sidebar close">
  ...
  <div class="home-section">
    ...
    <div class="container">
            <div class="title">Add New Class Schedule</div>
            <div class="content">
            <?php
            if(isset($error)){
           ...
           echo '<div style="padding:20px 0px;" role="alert">
            ...
            <form method="POST">
                                            <div class="user-details">
                                                ...
                                                <div class="button">
                                                    <button name="add_schedule" type="submit">Add Class Schedule</button>
                                                </div>
                                            </div>
            </form>
        </div>
