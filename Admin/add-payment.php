    ...
    $date = $_POST['payment_date'];
      ...
      if (!empty($sub_id) || !empty($amount) || !empty($date)) {
         ...
         if (mysqli_connect_error()) {
           ...
           {
             $SELECT = "SELECT sub_id From payments Where sub_id = ? Limit 1";
             $INSERT = "INSERT Into payments (sub_id, amount_paid, payment_date) values(?, ?, ?)";
             ...
             if ($rnum==0) {
                 ...
                 $stmt->bind_param("iss", $sub_id, $amount, $date);
                 $stmt->execute();
                 ?>
           ...
           echo '<div style="padding:20px 0px;" role="alert">
            ...
            <form method="POST">
                                            <div class="user-details">
                                                ...
                                                <div class="button">
                                                    <button name="add_payment" type="submit">Add Payment</button>
                                                </div>
                                            </div>
            </form>
        </div>
