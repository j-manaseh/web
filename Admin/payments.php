...
<div class="sidebar close">
  ...
  <div class="home-section">
    ...
    <div class="container">
            ...
            <div class="heading">
                <button class="btn"><a href="add-payment.php" >Create New Payment</a></button>
            </div>
          <table class="table">
            <thead>
                <tr>
                ...
                if(mysqli_num_rows($query_run) > 0)
                {
                    foreach($query_run as $row)
                    {
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="edit-payment.php?id=<?= $row['payment_id']; ?>" method="POST">
                                    <button type="submit" name="payment_edit" value="<?= $row['payment_id']; ?>">Edit</button>
                                </form>
                            </td>
                            <td>
                                <form action="code.php" method="POST">
                                    <button type="submit" name="payment_delete" class="table-delete" value="<?= $row['payment_id']; ?>">Delete</button>
                                </form>
                            </td>
                        </tr>
                        <?php
