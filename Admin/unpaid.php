...
<div class="sidebar close">
  ...
  <div class="home-section">
    ...
    <div class="container">
            <div class="title">All Unpaid Invoices</div>
            <div class="content">
            <div class="attendance-list">
            <div class="heading">
                <button class="btn"><a href="add-invoice.php" >Create New Invoice</a></button>
            </div>
          <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                <?php
                $query = "SELECT * FROM unpaid_invoices";
                ...
                if(mysqli_num_rows($query_run) > 0)
                {
                    foreach($query_run as $row)
                    {
                        ...
                        <tr>
                            ...
                            <td><?= $row['amount']; ?></td>                         
                            <td>
                                <form action="edit-invoice.php?id=<?= $row['invoice_id']; ?>" method="POST">
                                    <button type="submit" name="invoice_edit" value="<?= $row['invoice_id']; ?>">Edit</button>
                                </form>
                            </td>
                            <td>
                                <form action="code.php" method="POST">
                                    <button type="submit" name="invoice_delete" class="table-delete" value="<?= $row['invoice_id']; ?>">Delete</button>
                                </form>
                            </td>
                        </tr>
                        <?php
