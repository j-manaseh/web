...
if(isset($_POST['add_user']))
{
    ...
    if (count($errors) == 0) {
        ...
        if (mysqli_connect_error()) {
            ...
            $INSERT = "INSERT INTO members (id, fname, lname, email, gender, password, phone, plan_name, status, date_added, account_type) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            if ($rnum == 0) {
                ...
                $stmt->bind_param("isssssisiss", $id, $fname, $lname, $email, $gender, $secure_pass, $phone, $plan_name, $status, $date_added, $account_type);
