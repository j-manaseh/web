...
<div class="sidebar close">
  ...
  <div class="home-section">
    ...
    <div class="container">
            <div class="title">Fitness Instructors</div>
            <div class="content">
            <div class="attendance-list">
            <div class="heading">
              <button class="btn"><a href="add-instructor.php" >Add New Instructor</a></button>
            </div>
          <table class="table">
            <thead>
                <tr>
                ...
                if(mysqli_num_rows($query_run) > 0)
                {
                    foreach($query_run as $row)
                    {
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="edit-instructor.php?id=<?= $row['instructor_id']; ?>" method="POST">
                                    <button type="submit" name="edit_instructor" value="<?= $row['instructor_id']; ?>">Edit</button>
                                </form>
                            </td>
                            <td>
                                <form action="code.php" method="POST">
                                    <button type="submit" name="instructor_delete" class="table-delete" value="<?= $row['instructor_id']; ?>">Delete</button>
                                </form>
                            </td>
                        </tr>
                        <?php
