...
if (isset($_POST['submit'])) {
    ...
    if (empty($plan_name) || empty($duration) || empty($amount)) {
        // Handle validation errors
        die("Every field MUST be filled");
    }

// Prepare an UPDATE statement to update the user record
$stmt = $conn->prepare("UPDATE plans SET plan_name=?, duration=?, amount=? WHERE plan_id=?");
$stmt->bind_param("ssii", $plan_name, $duration, $amount, $id);
            ...
            <form method="POST">
                                            <div class="user-details">
                                                ...
                                                <div class="input-box">
                                                    ...
                                                    <input type="text" name="duration" value="<?= $user['duration'];?>" class="form-control" required>
                                                </div>

                                                <div class="input-box">
                                                    <label for="">Amount</label>
                                                    <input type="integer" name="amount" value="<?= $user['amount'];?>" class="form-control" required>
                                                </div>
