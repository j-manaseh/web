    ...
    $amount = $_POST['amount'];
      ...
      if (!empty($plan_name) || !empty($duration) || !empty($amount)) {
         ...
         if (mysqli_connect_error()) {
           ...
           {
             $SELECT = "SELECT plan_name From plans Where plan_name = ? Limit 1";
             $INSERT = "INSERT Into plans (plan_name, duration, amount) values(?, ?, ?)";
             ...
             if ($rnum==0) {
                 ...
                 $stmt->bind_param("sss", $plan_name, $duration, $amount);
                 $stmt->execute();
                 ?>
           ...
           echo '<div style="padding:20px 0px;" role="alert">
            ...
            <form method="POST">
                                            <div class="user-details">
                                                ...
                                                <div class="button">
                                                    <button name="add_plan" type="submit">Add Membership Plan</button>
                                                </div>
                                            </div>
            </form>
        </div>
