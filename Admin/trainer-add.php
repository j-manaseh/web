    ...
    $phone = $_POST['phone'];
      ...
      if (!empty($name) || !empty($class) || !empty($email) || !empty($phone)) {
         ...
         if (mysqli_connect_error()) {
           ...
           {
             $SELECT = "SELECT email From trainers Where email = ? Limit 1";
             $INSERT = "INSERT Into trainers (trainer_name, class, email, phone) values(?, ?, ?, ?)";
             ...
             if ($rnum==0) {
                 ...
                 $stmt->bind_param("sssi", $name, $class, $email, $phone);
                 $stmt->execute();
                 ?>
             ...
             {
                $error[] = 'This email is already registered to another trainer.';  
             } 
...
<div class="sidebar close">
  ...
  <div class="home-section">
    ...
    <div class="container">
            <div class="title">Add New Trainer</div>
            <div class="content">
            <?php
            if(isset($error)){
           ...
           echo '<div style="padding:20px 0px;" role="alert">
            ...
            <form method="POST">
                                            <div class="user-details">
                                                ...
                                                <div class="button">
                                                    <button name="add_trainer" type="submit">Add Trainer</button>
                                                </div>
                                            </div>
            </form>
        </div>
