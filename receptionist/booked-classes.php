...
<div class="sidebar close">
  ...
  <div class="home-section">
    ...
    <div class="container">
            <div class="title">All Booked Classes</div>
            <div class="content">
            <div class="attendance-list">
            <div class="heading">
              <button class="btn"><a href="book-class.php" >Book New Class</a></button>
            </div>
          <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                <?php
                $query = "SELECT * FROM booked_classes";
                ...
                if(mysqli_num_rows($query_run) > 0)
                {
                    foreach($query_run as $row)
                    {
                        ...
                        <tr>
                            ...
                            <td><?= $row['location']; ?></td>
                            <td>
                                <form action="edit-booking.php?id=<?= $row['class_booking_id']; ?>" method="POST">
                                    <button type="submit" name="edit_booking" value="<?= $row['class_booking_id']; ?>">Edit</button>
                                </form>
                            </td>
                            <td>
                                <form action="code.php" method="POST">
                                    <button type="submit" name="booking_delete" class="table-delete" value="<?= $row['class_booking_id']; ?>">Delete</button>
                                </form>
                            </td>
                        </tr>
                        <?php
