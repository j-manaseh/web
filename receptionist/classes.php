...
<div class="sidebar close">
  ...
  <div class="home-section">
    ...
    <div class="container">
            <div class="title">All Our Classes</div>
            <div class="content">
            <div class="attendance-list">
            <div class="heading">
              <button class="btn"><a href="classes-add.php" >Add New Class</a></button>
              <button class="btn"><a href="book-class.php" >Book a Class</a></button>
            </div>
          <table class="table">
            <thead>
                <tr>
                ...
                if(mysqli_num_rows($query_run) > 0)
                {
                    foreach($query_run as $row)
                    {
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="classes-edit.php?id=<?= $row['class_id']; ?>" method="POST">
                                    <button type="submit" name="class_edit" value="<?= $row['class_id']; ?>">Edit</button>
                                </form>
                            </td>
                            <td>
                                <form action="code.php" method="POST">
                                    <button type="submit" name="class_delete" class="table-delete" value="<?= $row['class_id']; ?>">Delete</button>
                                </form>
                            </td>
                        </tr>
                        <?php
