...
<div class="sidebar close">
  ...
  <div class="home-section">
    ...
    <div class="container">
            <div class="title">All Membership Plans</div>
            <div class="content">
            <div class="attendance-list">
            <div class="heading">
                <button class="btn"><a href="add-plans.php" >Add New Membership Plan</a></button>
            </div>
          <table class="table">
            <thead>
                <tr>
                ...
                if(mysqli_num_rows($query_run) > 0)
                {
                    foreach($query_run as $row)
                    {
                        ...
                        <tr>
                            ...
                            <td><?= $row['amount']; ?></td>
                            <td>
                                <form action="edit-plan.php?id=<?= $row['plan_id']; ?>" method="POST">
                                    <button type="submit" name="plan_edit" value="<?= $row['plan_id']; ?>">Edit</button>
                                </form>
                            </td>
                            <td>
                                <form action="code.php" method="POST">
                                    <button type="submit" name="plan_delete" class="table-delete" value="<?= $row['plan_id']; ?>">Delete</button>
                                </form>
                            </td>
                        </tr>
                        <?php
