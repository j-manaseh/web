...
<div class="sidebar close">
  ...
  <div class="home-section">
    ...
    <div class="container">
            <div class="title">Facility Equipments</div>
            <div class="content">
            <div class="attendance-list">
            <div class="heading">
                <button class="btn"><a href="add-equipment.php" >Add New Equipment</a></button>
            </div>
          <table class="table">
            <thead>
                <tr>
                ...
                if(mysqli_num_rows($query_run) > 0)
                {
                    foreach($query_run as $row)
                    {
                        ...
                        <tr>
                            ...
                            <td><?= $row['available']; ?></td>
                            <td>
                                <form action="edit-equipment.php?id=<?= $row['id']; ?>" method="POST">
                                    <button type="submit" name="equipment_edit" value="<?= $row['id']; ?>">Edit</button>
                                </form>
                            </td>
                            <td>
                                <form action="code.php" method="POST">
                                    <button type="submit" name="equipment_delete" class="table-delete" value="<?= $row['id']; ?>">Delete</button>
                                </form>
                            </td>
                        </tr>
                        <?php
