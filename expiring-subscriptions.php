...
<div class="sidebar close">
  ...
  <div class="home-section">
    ...
    <div class="container">
            <div class="title">Expiring Subscriptions</div>
            <div class="content">
            <div class="attendance-list">
            <div class="heading">
                <button class="btn"><a href="add-subscription.php" >Create New Subscription</a></button>
            </div>
          <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                <?php
                $query = "SELECT * FROM expiring_subscriptions";
                ...
                if(mysqli_num_rows($query_run) > 0)
                {
                    foreach($query_run as $row)
                    {
                        ...
                        <tr>
                            ...
                            <td><?= $row['end_date']; ?></td>
                            <td>
                                <form action="edit-subscription.php?id=<?= $row['sub_id']; ?>" method="POST">
                                    <button type="submit" name="invoice_edit" value="<?= $row['sub_id']; ?>">Edit</button>
                                </form>
                            </td>
                            <td>
                                <form action="code.php" method="POST">
                                    <button type="submit" name="sub_delete3" class="table-delete" value="<?= $row['sub_id']; ?>">Delete</button>
                                </form>
                            </td>
                        </tr>
                        <?php
