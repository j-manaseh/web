...
<div class="sidebar close">
  ...
  <div class="home-section">
    ...
    <div class="container">
            <div class="title"> Booked Health Spa Sessions</div>
            <div class="content">
            <div class="attendance-list">
            <div class="heading">
              <button class="btn"><a href="add-booking.php" >Book Health Spa Session</a></button>
            </div>
          <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                <?php
                $query = "SELECT * FROM spa_session_bookings";
                ...
                if(mysqli_num_rows($query_run) > 0)
                {
                    foreach($query_run as $row)
                    {
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="edit-booking.php?id=<?= $row['booking_id']; ?>" method="POST">
                                    <button type="submit" name="edit_booking" value="<?= $row['booking_id']; ?>">Edit</button>
                                </form>
                            </td>
                            <td>
                                <form action="code.php" method="POST">
                                    <button type="submit" name="spa_booking_delete" class="table-delete" value="<?= $row['booking_id']; ?>">Delete</button>
                                </form>
                            </td>
                        </tr>
                        <?php
